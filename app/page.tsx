      ...
      <main className="container mx-auto px-4 sm:px-6 py-8 sm:py-16 flex flex-col items-center relative w-full overflow-x-hidden" style={{ zIndex: 1 }}>
        ...
        {!hasFiles ? (
          <div className="w-full max-w-5xl px-2 sm:px-4 md:px-6">
            {/* Upload Area */}
            <div className="relative glass-droplet-inner rounded-[1.5rem] sm:rounded-[2rem] p-8 sm:p-8 md:p-12 lg:p-20 min-h-[250px] border border-white/30 shadow-2xl text-center overflow-hidden">
            ...
            <div className="mt-12">
              <div className="grid grid-cols-3 gap-2 sm:gap-4 md:gap-6">
                {/* Step 1 */}
                <div className="group bg-gradient-to-br from-purple-400 via-purple-500 to-purple-600 rounded-xl sm:rounded-2xl md:rounded-3xl p-2 sm:p-4 md:p-6 lg:p-8 border border-purple-300/50 hover:-translate-y-1 transition-all duration-300 hover:shadow-xl hover:from-purple-500 hover:via-purple-600 hover:to-purple-700">
                  <div className="flex flex-col items-center text-center space-y-2 sm:space-y-4">
                    <div className="w-8 h-8 sm:w-12 sm:h-12 md:w-16 md:h-16 bg-white/30 backdrop-blur-sm rounded-xl sm:rounded-2xl flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all duration-300 group-hover:scale-105">
                      <UploadCloud className="w-4 h-4 sm:w-6 sm:h-6 md:w-8 md:h-8 text-white" />
                    </div>
                    <div className="space-y-1 sm:space-y-2">
                      <h3 className="text-[10px] sm:text-sm md:text-base lg:text-xl font-bold text-white">1. Dosya Seç</h3>
                      <p className="text-[8px] sm:text-xs md:text-sm text-purple-50 leading-relaxed hidden sm:block">
                ...
                <div className="group bg-gradient-to-br from-purple-400 via-purple-500 to-purple-600 rounded-xl sm:rounded-2xl md:rounded-3xl p-2 sm:p-4 md:p-6 lg:p-8 border border-purple-300/50 hover:-translate-y-1 transition-all duration-300 hover:shadow-xl hover:from-purple-500 hover:via-purple-600 hover:to-purple-700">
                  <div className="flex flex-col items-center text-center space-y-2 sm:space-y-4">
                    <div className="w-8 h-8 sm:w-12 sm:h-12 md:w-16 md:h-16 bg-white/30 backdrop-blur-sm rounded-xl sm:rounded-2xl flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all duration-300 group-hover:scale-105">
                      <SlidersHorizontal className="w-4 h-4 sm:w-6 sm:h-6 md:w-8 md:h-8 text-white" />
                    </div>
                    <div className="space-y-1 sm:space-y-2">
                      <h3 className="text-[10px] sm:text-sm md:text-base lg:text-xl font-bold text-white">2. Biçim Seç</h3>
                      <p className="text-[8px] sm:text-xs md:text-sm text-purple-50 leading-relaxed hidden sm:block">
                ...
                <div className="group bg-gradient-to-br from-purple-400 via-purple-500 to-purple-600 rounded-xl sm:rounded-2xl md:rounded-3xl p-2 sm:p-4 md:p-6 lg:p-8 border border-purple-300/50 hover:-translate-y-1 transition-all duration-300 hover:shadow-xl hover:from-purple-500 hover:via-purple-600 hover:to-purple-700">
                  <div className="flex flex-col items-center text-center space-y-2 sm:space-y-4">
                    <div className="w-8 h-8 sm:w-12 sm:h-12 md:w-16 md:h-16 bg-white/30 backdrop-blur-sm rounded-xl sm:rounded-2xl flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all duration-300 group-hover:scale-105">
                      <Download className="w-4 h-4 sm:w-6 sm:h-6 md:w-8 md:h-8 text-white" />
                    </div>
                    <div className="space-y-1 sm:space-y-2">
                      <h3 className="text-[10px] sm:text-sm md:text-base lg:text-xl font-bold text-white">3. İndir</h3>
                      <p className="text-[8px] sm:text-xs md:text-sm text-purple-50 leading-relaxed hidden sm:block">
